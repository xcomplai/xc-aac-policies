...
package cis_rhel8.metadata

import rego.v1

default schema := "fact_contract/v1"
default display_name := "CIS Red Hat Enterprise Linux 8 v3.0.0"
default framework_key := "cis_rhel8"
default framework_version := "3.0.0"
default domain := "security"
default collection := "xcomplai.cis_os"
default collection_version_min := "1.0.0"
default opa_endpoint_path := "/v1/data/cis_rhel8/main/compliance_report"
default pg_table := "compliance_results"
default dashboard_uid := "cis-rhel8"
